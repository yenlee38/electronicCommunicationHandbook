...
public class ScheduleTeacherAdapter extends RecyclerView.Adapter<ScheduleTeacherAdapter.ScheduleViewHolder> {
    private ArrayList<Class> mClassOfDay;
    public ScheduleTeacherAdapter(ArrayList<Class> mClassOfDay) {
    ...
    @NonNull
    @Override
    public ScheduleTeacherAdapter.ScheduleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_chedule,parent, false);
        return new ScheduleTeacherAdapter.ScheduleViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ScheduleTeacherAdapter.ScheduleViewHolder holder, int position) {
